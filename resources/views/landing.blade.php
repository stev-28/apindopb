...
<body class="bg-gray-50 font-sans scroll-smooth">
    ...
    <section id="pendaftaran" class="py-16 bg-apindo-dark text-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
            ...
            {{-- Form Pendaftaran --}}
            <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-2xl shadow-2xl space-y-6">
                @csrf
