...
<head>
    ...
    <title>Detail Pendaftaran - <?php echo e($registration->nama); ?></title>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">ID: #<?php echo e($registration->id); ?></p>
                    </div>
                    <div class="flex items-center space-x-2">
                        ...
                        <form action="<?php echo e(route('admin.destroy', $registration->id)); ?>" 
                              method="POST" 
                              class="inline"
                              onsubmit="return confirmDelete('<?php echo e($registration->nama); ?>')">
                            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-900"><?php echo e($registration->nama); ?></p>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">Asal Kabupaten</label>
                        <p class="text-lg font-semibold text-gray-900"><?php echo e($registration->kabupaten); ?></p>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">Email</label>
                        <p class="text-lg text-gray-900">
                            <a href="mailto:<?php echo e($registration->email); ?>" class="text-blue-600 hover:underline">
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-900">
                            <a href="https://wa.me/62<?php echo e(substr($registration->telepon, 1)); ?>" target="_blank" 
                               class="text-green-600 hover:underline">
                                <?php echo e($registration->telepon); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <?php if($registration->surat_mandat): ?>
                            <div class="mt-2">
                                <a href="<?php echo e(Storage::url($registration->surat_mandat)); ?>" target="_blank" 
                                ...
                                <p class="text-sm text-gray-500 mt-2"><?php echo e($registration->surat_mandat); ?></p>
                            </div>
                        <?php else: ?>
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-900">
                            <?php echo e($registration->created_at->format('d F Y, H:i:s')); ?>
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-900">
                            <?php echo e($registration->updated_at->format('d F Y, H:i:s')); ?>
...
<?php /**PATH C:\Users\pusda\Documents\StevieWeb\APINDOPB\resources\views/admin/show.blade.php ENDPATH**/ ?>