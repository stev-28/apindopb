    ...
    <div class="container mx-auto flex items-center justify-between">
        <div class="flex items-center flex-1">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm opacity-95"><?php echo e(session('success')); ?></p>
            </div>
        </div>
...
<?php /**PATH C:\Users\pusda\Documents\StevieWeb\APINDOPB\resources\views/partials/alert.blade.php ENDPATH**/ ?>