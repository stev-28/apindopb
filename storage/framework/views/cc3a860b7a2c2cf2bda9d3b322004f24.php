...
<body class="bg-gray-50">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="bg-green-100 text-green-800 px-4 py-2 rounded-lg font-semibold">
                            Total: <?php echo e($registrations->count()); ?> Pendaftar
                        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($registration->nama); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-700"><?php echo e($registration->kabupaten); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-700"><?php echo e($registration->email); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-700"><?php echo e($registration->telepon); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <div class="flex items-center space-x-3">
                                        <a href="<?php echo e(route('admin.show', $registration->id)); ?>" 
    ...
    <script>
        ...
        function exportToCSV() {
            const data = <?php echo json_encode($registrations, 15, 512) ?>;
...
<?php /**PATH C:\Users\pusda\Documents\StevieWeb\APINDOPB\resources\views/admin/index.blade.php ENDPATH**/ ?>